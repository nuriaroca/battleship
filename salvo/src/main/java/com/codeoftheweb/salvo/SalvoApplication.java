...
public class SalvoApplication {
    ...
    public CommandLineRunner initData(PlayerRepository playerRepo, GameRepository gameRepo, GamePlayerRepository gamePlayerRepo, ShipRepository shipRepo, SalvoRepository salvoRepo, ScoreRepository scoreRepo) {
        return (args) -> {
            ...
            Salvo sv5 = new Salvo(gp1,1, Arrays.asList("A2", "A4", "G6"));
            Salvo sv6 = new Salvo(gp2,1, Arrays.asList("B5", "D5", "C7"));
            Salvo sv7 = new Salvo(gp1,2, Arrays.asList("A3", "H6"));
            Salvo sv8 = new Salvo(gp2,2, Arrays.asList("C5", "C6"));
            Salvo sv9 = new Salvo(gp2,1, Arrays.asList("G6", "H6", "A4"));
            Salvo sv10 = new Salvo(gp3,1, Arrays.asList("H1", "H2", "H3"));
            Salvo sv11 = new Salvo(gp2,2, Arrays.asList("A2", "A3", "D8"));
            Salvo sv12 = new Salvo(gp3,2, Arrays.asList("E1", "F2", "G3"));
            Salvo sv13 = new Salvo(gp2,1, Arrays.asList("A3", "A4", "F7"));
            Salvo sv14 = new Salvo(gp1,1, Arrays.asList("B5", "C6", "H1"));
            Salvo sv15 = new Salvo(gp2,2, Arrays.asList("A2", "G6", "H6"));
            Salvo sv16 = new Salvo(gp1,2, Arrays.asList("C5", "C7", "D5"));
            Salvo sv17 = new Salvo(gp3,1, Arrays.asList("A1", "A2", "A3"));
            Salvo sv18 = new Salvo(gp1,1, Arrays.asList("B5", "B6", "C7"));
            Salvo sv19 = new Salvo(gp3,2, Arrays.asList("G6", "7", "E6"));
            Salvo sv20 = new Salvo(gp1,2, Arrays.asList("C6", "D6", "E6"));
            Salvo sv21 = new Salvo(gp1,3, Arrays.asList("H1", "H8"));
